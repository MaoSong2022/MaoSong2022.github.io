...
N\\
B
\end{bmatrix}\label{Frenet-Serret formula} $$
...
T\\
N\\
\end{bmatrix}\label{simplfied_frenet_formula} $$
...
$a$和$\kappa_x$可以联立$\ddot{s}$和$\ddot{l}$式求解线性方程组得到。
