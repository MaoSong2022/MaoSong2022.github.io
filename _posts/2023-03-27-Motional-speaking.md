...
![Continuous Learning Framework](motional_continuous_learning_framework.png)
...
![one planning loop](motional_planning_loop.png)


![differentiable training process](motional_closed_loop_training.png)
...
![Graph attention network models](motional_graph_attention_network.png)
...
![2D gaussian model](motional_2d_gaussian_model.png)
