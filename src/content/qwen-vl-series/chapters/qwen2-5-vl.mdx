...
import qwen2_5_vl_architecture from "../../../assets/image/Qwen2-5-VL-architecture.png";
import qwen2_5_vl_model_config from "../../../assets/image/Qwen2-5-VL-model_config.png";
import qwen2_5_vl_pretraining from "../../../assets/image/Qwen2-5-VL-pretraining.png";
import qwen2_5_vl_general_vqa from "../../../assets/image/Qwen2-5-VL-general_vqa.png";
import qwen2_5_vl_document_understanding from "../../../assets/image/Qwen2-5-VL-document_understanding.png";
import qwen2_5_vl_grounding from "../../../assets/image/Qwen2-5-VL-grounding.png";
import qwen2_5_vl_video from "../../../assets/image/Qwen2-5-VL-video.png";
import qwen2_5_vl_agent from "../../../assets/image/Qwen2-5-VL-agent.png";

## Qwen2.5 VL

2025年2月20号 Qwen 团队发布了Qwen2.5 VL [Qwen2.5-VL] 技术报告，Qwen2.5 VL包括3B，7B， 72B三个size。Qwen2.5-VL主要在架构，数据上进行了改进。
通过评测，Qwen2.5-VL在多个benchmark上取得了SOTA。
...
<Image src={qwen2_5_vl_architecture} alt="Qwen2.5 VL架构图" />
...
<Image src={qwen2_5_vl_model_config} alt="Qwen2.5 VL模型参数配置" />
...
<Image src={qwen2_5_vl_pretraining} alt="Qwen2.5 VL预训练阶段" />
...
post-training阶段分为SFT和[DPO](/p/notes-on-dpo/)两个小阶段，这个阶段都会冻结VIT. SFT阶段使用大多数的训练数据，而DPO阶段专注于image-text data和pure text data，以更好地进行对齐。具体做法就是基于Grounding truth，使用checkpoint来评估数据的质量，然后只保留答案正确的数据来训练。

### Evaluation

1. 通用VQA
   <Image src={qwen2_5_vl_general_vqa} alt="通用VQA" />
2. 文档理解和OCR
   <Image src={qwen2_5_vl_document_understanding} alt="文档理解和OCR" />
3. 空间理解
   <Image src={qwen2_5_vl_grounding} alt="空间理解" />
4. 视频理解和Grounding
   <Image src={qwen2_5_vl_video} alt="视频理解和Grounding" />
5. Agent
   <Image src={qwen2_5_vl_agent} alt="Agent" />
