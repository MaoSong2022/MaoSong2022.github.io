...
作者在本文中提出了 Qwen3-VL [@Qwen3-VL] 系列多模态大模型，包括 4 个 dense 模型和两个 MoE 模型，模型的上下文长度为 256K, 通过数据和训练上的优化，作者保持了模型的纯文本能力。最终 Qwen3-VL 包括 non-thinking 和 thinking variants.

在架构上，Qwen3-VL 进行了三点改进：

1. Interleaved MRoPE: 作者解决了 [Qwen2.5-VL](#qwen2.5-vl) 提出的 MRoPE 在长视频理解场景下的频谱不平衡问题
...
<Image
  src={qwen3_vl_post_training_pipeline}
