---
title: Notes on VITA
description: The first-ever open-source Multimodal Large Language Model (MLLM) adept
  at simultaneous processing and analysis of Video, Image, Text, and Audio modalities,
  and meanwhile has an advanced multimodal interactive experience.
authors:
- name: Mao Song
  url: https://maosong.website/
published: 2024-08-13 14:36:45+0800
modified: 2024-08-13 14:36:45+0800
tags:
- Paper Reading
- Video
- Audio
...
- MLLM
showPdf: false
seoThumbImage: /posts/notes-on-vita/VITA_SFT_data.png
---
import Image from '../../../components/Image.astro';
import vita_architecture from '../../../assets/image/VITA_architecture.png';
import vita_sft_data from '../../../assets/image/VITA_SFT_data.png';
import vita_training_pipeline from '../../../assets/image/VITA_training_pipeline.png';
import vita_evaluation from '../../../assets/image/VITA_evaluation.png';
...
<Image src={vita_architecture} alt="Architecture of VITA" />
...
<Image src={vita_sft_data} alt="Training data of multimodal instruction tuning" />
...
<Image src={vita_training_pipeline} alt="Training pipeline of VITA" />
...
<Image src={vita_evaluation} alt="Evaluation on image and video understanding" />
