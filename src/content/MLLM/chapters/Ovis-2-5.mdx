...
description: 作者提出了 Ovis2.5, 一个基于 Ovis 改进的多模态大模型系列，包括 2B 和 9B 两个 size，Ovis2.5 主要强调了支持不同分辨率图片输入以及深度思考这两个
  feature
authors:
- name: Mao Song
  url: https://maosong.website/
published: 2025-08-30 17:34:44+0800
modified: 2025-08-30 17:34:44+0800
categories:
- MLLM
showPdf: false
seoThumbImage: /posts/ovis2-5-mllm-with-stronger-perception-and-reasoning-capability/Ovis-2-5-architecture.png
---
