...
import llava_v1_5_sft_mixture from "../../../assets/image/llava_v1_5_sft_mixture.png";
import apollo from "../../../assets/image/apollo.png";
import cambrain_7m from "../../../assets/image/cambrain-7M.png";
import mixture_the_cauldron from "../../../assets/image/mixture_the_cauldron.png";
import molmo_sft_data_mixture from "../../../assets/image/molmo_sft_data_mixture.png";
import eagle2_data_mixture from "../../../assets/image/eagle2_data_mixture.png";
import smol_vlm_data_mixture from "../../../assets/image/smol_vlm_data_mixture.png";
import mm1_5_data_mixture from "../../../assets/image/MM1_5_data_mixture.png";
...
1. general VQA
2. document understanding: OCR, chart, knowledge
3. Reasoning
4. multi-image
5. video
6. pure text
...
<Image src={llava_v1_5_sft_mixture} alt="LLaVA 1.5 SFT data mixture" />
...
<Image src={apollo} alt="apollo data mixture" />
...
<Image src={cambrain_7m} alt="Cambrain-7M" />
...
<Image src={mixture_the_cauldron} alt="data mixture of SmolVLM blog" />

### Molmo

[Molmo](http://arxiv.org/abs/2409.17146) 是Allen AI发布的一个多模态大模型，其SFT数据配比如下

<Image src={molmo_sft_data_mixture} alt="SFT data mixture of Molmo" />

### Eagle 2/2.5

Eagle (1/2/2.5) 是NVLab提出了系列多模态大模型，[Eagle 2](http://arxiv.org/abs/2501.14818) 给出了 stage 1.5 和 stage 2的数据配比

<Image src={eagle2_data_mixture} alt="Eagle 2 data mixture" />
...
<Image src={smol_vlm_data_mixture} alt="data mixture of SmolVLM paper" />
...
<Image src={mm1_5_data_mixture} alt="MM1.5 SFT data mixture" />
...
DataComp-VLM [@DataComp-VLM]

<HtmlEmbed
  src="embeds/d3-pie-domain.html"
  title="DCLM data mixtures"
  data="DCLM_mllm_mixture.json"
/>
