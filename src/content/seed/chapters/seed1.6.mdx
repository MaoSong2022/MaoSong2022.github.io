...
Seed 1.6 基于 Seed 1.5 开发，是一个 [Lecture 4-MoE](Lecture%204-MoE.md) 模型, 总参数为 230B, 激活参数为 23B.
...
| Model        | Seed1.6 Base | [LLaMA-4](LLaMA4.md) -Maverick Base | [DeepSeek-V3](DeepSeek-V3.md) Base | [Qwen3](Qwen3.md)-235B-A22B Base | Seed1.5 Base |
| ------------ | ------------ | ----------------------------------- | ---------------------------------- | -------------------------------- | ------------ |
...
Seed1.6-Thinking 与 [Seed-Thinking-v1.5](Seed-Thinking-v1.5.md) 的训练方式差不多，作者使用了 multi-stage rejection fine-tuning (RFT) 和 RL 来提高模型的表现。在每一轮中，先进行 RL 的训练，然后进行 RFT 的训练。相比于 [Seed-Thinking-v1.5](Seed-Thinking-v1.5.md), Seed1.6-Thinking 使用了更多的算力和更高质量的数据，包括数学问题，代码，谜题以及 non-reasoning 数据。
