...
description: Kimi-k2 是一个总参数为 1T, 激活参数为 32B 的 MoE 大语言模型，模型使用 15.5T token 进行训练，optimizer
  使用了 MuonClip. 作者主要关注模型的 agent 能力
authors:
- name: Mao Song
  url: https://maosong.website/
published: 2025-07-24 10:56:50+0800
...
- LLM
showPdf: false
seoThumbImage: /posts/notes-on-kimi-k2/Kimi-K2-attention-heads.png
---
import Image from '../../../components/Image.astro';
import kimi_k2_sparsity_scaling_law from '../../../assets/image/Kimi-K2-sparsity-scaling-law.png';
import kimi_k2_attention_heads from '../../../assets/image/Kimi-K2-attention-heads.png';
import kimi_k2_muonclip from '../../../assets/image/Kimi-k2-muonclip.png';
import kimi_k2_muonclip_performance from '../../../assets/image/Kimi-k2-muonclip-performance.png';
import kimi_k2_model_training_dynamics from '../../../assets/image/Kimi-k2-model-training-dynamics.png';
import kimi_k2_communication_computation from '../../../assets/image/Kimi-k2-communication-computation.png';
import kimi_k2_tool_use_synthetic_pipeline from '../../../assets/image/Kimi-k2-tool-use-synthetic-pipeline.png';
import kimi_k2_rl_infra from '../../../assets/image/Kimi-k2-RL-infra.png';
import kimi_k2_performance from '../../../assets/image/Kimi-k2-performance.png';
...
1. MuonClip, 一个基于 [Muon](/p/notes-on-moonlight/) 的优化算法，来提高 Kimi K2 对 token 的利用效率以及提高训练的稳定性
...
Kimi-K2 的架构与 [DeepSeek-V3](/p/notes-on-deepseek-v3/) 相似，配置如下表所示
...
<Image src={kimi_k2_sparsity_scaling_law} alt="Sparsity Scaling Law" />
...
<Image src={kimi_k2_attention_heads} alt="Scaling curves for attention heads" />
...
相比于 [Kimi-k1.5](/p/notes-on-kimi-k1.5/), Kimi-K2 使用了一个 rephrasing pipeline, 来提高高质量 token 的利用率，作者在 knowledge 和 mathematics domain 上进行了实验。
...
<Image src={kimi_k2_muonclip} alt="MuonClip Optimizer" />

接下来，作者对比了以下 Muon 和 MuonClip 两个优化器的表现，作者分别使用这两个优化器训练 53B-A9B 的 MoE 模型，实验结果如下

<Image src={kimi_k2_muonclip_performance} alt="Comparison between Muon and MuonClip" />
...
<Image src={kimi_k2_model_training_dynamics} alt="Training loss curve" />
...
<Image src={kimi_k2_communication_computation} alt="Kimi-K2 parallelism" />
...
预训练结束之后，作者加入了一个 long-context activation stage. 这个阶段，作者使用了 400B 的 4K 上下文的 token 和 60B 的 32K 上下文的 60B token. 最后作者使用 [YARN](/p/notes-on-yarn/) 将模型上下文长度扩展到 128K.
...
<Image src={kimi_k2_tool_use_synthetic_pipeline} alt="Data synthesis pipeline for tool use" />
...
<Image src={kimi_k2_rl_infra} alt="Kimi-K2 RL infra" />
...
<Image src={kimi_k2_performance} alt="Performance of Kimi-k2" />
