...
![Architecture of k1.5 base model](/posts/notes-on-kimi-k1-5/k1-5-model-arch.png)
...
![Large Scale Reinforcement Learning Training System for LLM](/posts/notes-on-kimi-k1-5/k1-5-training-system.png)
...
![Hybrid Deployment Framework](/posts/notes-on-kimi-k1-5/k1-5-hybrid-deployment-framework.png)
...
3. [DPO](/p/notes-on-dpo/)：通过对同一个问题进行多次采样，选择最短的正确的回答作为正样本，最长的回答作为负样本，然后使用DPO进行训练。
...
![Long-CoT-benchmark](/posts/notes-on-kimi-k1-5/k1-5-long-cot-benchmark.png)

2. K1.5在Short-CoT任务上的表现

![Short-CoT-benchmark](/posts/notes-on-kimi-k1-5/k1-5-short-cot-benchmark.png)
...
![Long2short](/posts/notes-on-kimi-k1-5/k1-5-long2short.png)
