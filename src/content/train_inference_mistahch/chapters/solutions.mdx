...
- GSPO [@GSPO]
- MiniRL
- @top-p sampling candidate sets [@mai_thinking_1]
...
Ring-Zero [@Ring-Zero] 进一步使用了 FP32 精度来计算 attention 部分的 softmax.
...
MiMo-V2.6 [@MiMo-V2.6] 在 RL 训练的时候冻结了 router, 发现这样可以提高负载均衡
