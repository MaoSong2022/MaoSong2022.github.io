...
published: 2025-07-22 10:50:47+0800
modified: 2025-12-24 15:12:10+0800
tags:
...
- Tutorial
showPdf: false
seoThumbImage: /posts/llm-parameter-computation/Qwen3_moe_param_distribution.png
---

本文中，我们介绍一下如何计算 LLM 的参数量。我们将基于 [Qwen3](/p/notes-on-qwen3/) 模型架构出发，对模型架构进行拆解，然后给出 LLM 参数量计算公式。

## Dense Model

我们首先来看一下 Qwen3 的架构，如下图所示

![Architecture of Qwen3](../../assets/image/LM_architecture.png)
...
![Parameter distribution across model components](../../assets/image/Qwen3_param_distribution.png)

![Parameter percentage across model components](../../assets/image/Qwen3_param_percentage.png)
...
![Parameter distribution across MoE model components](../../assets/image/Qwen3_moe_param_distribution.png)

![Parameter percentage across MoE model components](../../assets/image/Qwen3_moe_param_percentage.png)
