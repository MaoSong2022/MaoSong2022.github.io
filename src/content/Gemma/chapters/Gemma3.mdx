...
import gemma3Performance from '../../../assets/image/Gemma3-performance.png';
import gemma3SlidingWindowSize from '../../../assets/image/Gemma3-sliding_window_size.png';
import gemma3LongContext from '../../../assets/image/Gemma3-long_context.png';
import gemma3Memorization from '../../../assets/image/Gemma3-memorization.png';
...
<Image src={gemma3Performance} alt="performance of Gemma3" />

与PaliGemma 2的表现对比

![Comparison with PaliGemma 2](/posts/notes-on-gemma3/comparison_with_pali_gemma_2.png)
...
<Image src={gemma3SlidingWindowSize} alt="sliding window size" />

### Long context ablation

结论为long context会降低模型的性能

<Image src={gemma3LongContext} alt="long context" />
...
<Image src={gemma3Memorization} alt="memorization" />
