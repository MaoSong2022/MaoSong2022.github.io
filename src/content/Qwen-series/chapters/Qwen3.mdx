...
published: 2025-05-15 14:48:11+0800
modified: 2025-07-12 11:02:17+0800
tags:
- Qwen
categories:
- LLM
showPdf: false
seoThumbImage: /posts/notes-on-qwen3/Qwen3_chat_template.png
---

import Image from '../../../components/Image.astro';
import qwen3_post_training from '../../../assets/image/Qwen3_post-training.png';
import qwen3_chat_template from '../../../assets/image/Qwen3_chat_template.png';
import qwen3_thinking_budget_performance from '../../../assets/image/Qwen3_thinking_budget_performance.png';
import qwen3_distillation_ablation from '../../../assets/image/Qwen3_distillation_ablation.png';
import qwen3_stage_ablation from '../../../assets/image/Qwen3_stage_ablation.png';
...
Qwen3 的 dense 模型的架构与 [Qwen2.5](/p/notes-on-qwen2.5/) 基本一致，包括使用 [GQA](/p/notes-on-gqa/) , SwiGLU, RoPE, RMSNorm 和 pre-normalization. Qwen3 进一步移除了 QKV bias, 然 后加入了 [QK-Norm](/p/notes-on-qk-norm/) 来提高训练的稳定性。
...
<Image src={qwen3_post_training} alt="Post-training pipeline of Qwen3" />
...
<Image src={qwen3_chat_template} alt="Chat template of Qwen3" />
...
<Image src={qwen3_thinking_budget_performance} alt="Performance according to thinking budget" />

**Efficiency of distillation**. 作者发现使用 distillation 可以大幅度提高模型的表现和训练效率。下面是结果如下图所示

<Image src={qwen3_distillation_ablation} alt="Comparison between distillation and RL" />
...
<Image src={qwen3_stage_ablation} alt="Performance of different stages" />
