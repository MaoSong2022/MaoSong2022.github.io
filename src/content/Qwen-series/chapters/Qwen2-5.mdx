...
2024 年 12 月 Qwen 发布了 Qwen 2.5 [@Qwen2.5] 系列大语言模型，包括 7 个 dense 模型以及两个 MoE 模型，Qwen2.5 在 pre-training 阶段使用了 18T token 进行。在 post-training 阶段使用了 1M 的样本，还使用了 [DPO](/p/notes-on-dpo/) 以及 GRPO 来进行 RL 的训练
