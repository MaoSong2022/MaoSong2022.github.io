...
description: Keye-VL 是快手在 25 年 7 月份提出的一个 8B 的多模态大模型，其亮点为短视频理解能力。预训练包括 4 个 stage，使用了
  600B token，后训练包括 2 个 stage，用于提升模型的 reasoning 和 non-reasoning 能力。
authors:
- name: Mao Song
  url: https://maosong.website/
published: 2025-07-23 11:11:43+0800
modified: 2025-07-23 11:11:43+0800
tags:
- Kuaishou
- Reasoning
categories:
- MLLM
showPdf: false
seoThumbImage: /posts/notes-on-keye-vl/Keye-VL-architecture.png
---
import Image from '../../../components/Image.astro';
import keye_vl_architecture from '../../../assets/image/Keye-VL-architecture.png';
import keye_vl_non_reasoning_training from '../../../assets/image/Keye-VL-non-reasoning-training.png';
import keye_vl_reasoning_training from '../../../assets/image/Keye-VL-reasoning-training.png';
import keye_vl_performance from '../../../assets/image/Keye-VL-performance.png';
import keye_vl_performance_internal from '../../../assets/image/Keye-VL-performance-internal.png';
...
Keye-VL 是一个标准的 ViT-MLP-LLM 的架构，其中，ViT 是 SigLIP-400M-384-14, MLP 是一个基于 SwiGLU 的 2 层 MLP，使用了和 [Qwen2.5-VL](/p/notes-on-qwen2.5-vl/) 一样的 patch merge 方法，LLM 使用的是 Qwen3-8B，模型架构示意图如下

<Image src={keye_vl_architecture} alt="Keye-VL model architecture" />
...
<Image src={keye_vl_non_reasoning_training} alt="Non reasoning training pipeline" />
...
<Image src={keye_vl_reasoning_training} alt="Non reasoning training pipeline" />
...
<Image src={keye_vl_performance} alt="Performance of Keye-VL" />
...
<Image src={keye_vl_performance_internal} alt="Performance of Keye-VL on the internal benchmark" />
