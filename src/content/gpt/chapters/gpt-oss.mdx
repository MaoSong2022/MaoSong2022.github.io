...
description: openAI 发布了 gpt-oss 大语言模型，包含 120B-A5.1B 以及 20.9B-A3.6B 两个 size, 作者强调了模型的
  instruction following, tool use, 以及 adaptive thinking 能力
authors:
- name: Mao Song
...
预训练细节不多，主要是使用了 [flash attention](/p/notes-on-flashattention/) 进行加速计算，使用了 Triton 进行了 kernel 的优化，gpt-oss-120b 训练了 120M H100-hours, gpt-oss-20B 的训练时间是 gpt-oss-120Bd 的十分之一左右
...
作者提出了 gpt-oss 系列大语言模型，gpt-oss 在架构上与已有的主流模型架构如 [Qwen3](/p/notes-on-qwen3/), [DeepSeek-V3](/p/notes-on-deepseek-v3/) 等都有一定区别
