...
published: 2025-12-24 15:19:42+0800
modified: 2025-12-24 15:19:42+0800
tags:
- position encoding
categories:
- LLM
showPdf: false
seoThumbImage: /posts/notes-on-nope/NoPE-similarity.png
---
import Image from '../../../components/Image.astro';
import nope_similarity from '../../../assets/image/NoPE-similarity.png';
import nope_softmax_hyperparameter from '../../../assets/image/NoPE-softmax-hyperparameter.png';

## Introduction

【参考文献 1】中系统性对比了 [AliBi](/p/notes-on-alibi/), [RoPE](/p/notes-on-position-encoding/) , [T5](/p/notes-on-t5/) 提出的 T5 bias 以及 Transformer 提出的绝对位置编码 (APE).
...
<Image src={nope_similarity} alt="Distance of NoPE with other position encodings" />

实验结果表明，NoPE 与 [T5](/p/notes-on-t5/) 提出的 T5 bias 最相似。
...
<Image src={nope_softmax_hyperparameter} alt="impact of softmax hyper-parameter on NoPE" />
