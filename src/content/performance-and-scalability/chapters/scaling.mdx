...
published: '2026-03-26 17:44:26+08:00'
modified: '2026-03-26 17:44:26+08:00'
tags:
- Scaling Law
categories:
- Infra
showPdf: false
seoThumbImage: /posts/performance-and-scalability/strong-scaling.png
---
import Image from '../../../components/Image.astro';
import strong_scaling from '../../../assets/image/strong-scaling.png';
import weak_scaling from '../../../assets/image/weak-scaling.png';
...
<Image src={strong_scaling} alt="illustration of strong scaling" />

## Gustafson's Law

但是在某些情况下，我们希望使用更多的处理器来处理更大的问题，这种 scaling 被称为 **weak scaling**,  其示意图如下所示

<Image src={weak_scaling} alt="illustration of weak scaling" />
