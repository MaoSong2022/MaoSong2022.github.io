...
published: 2025-04-30 10:44:19+0800
modified: 2025-04-30 10:44:19+0800
tags:
- LLaMA
categories:
- LLM
showPdf: false
seoThumbImage: /posts/notes-on-llama4-blog/architecture.png
---
...
<Image src={architecture} alt="architecture of LLaMA 4" />
...
1. MetaP：用于选择超参数
2. FP8 precision：与 [DeepSeek-V3](/p/notes-on-deepseek-v3/) 一样，使用FP8精度进行训练
...
LLaMA 4 采用了MoE架构，是一个原生的多模态大模型系列。在架构上，与DeepSeek-MoE, aria和OLMoE不同，LLaMA4并没有增加expert granularity，[OLMoE](/p/notes-on-olmoe/)分析认为，增加granularity可以提高模型的flexibility，
下面总结了一下相关模型的参数
