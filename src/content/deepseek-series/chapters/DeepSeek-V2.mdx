...
基于这两个问题，作者在本文中提出了 DeepSeek-V2 [@DeepSeek-V2]，一个开源的 MoE 模型，DeepSeek-V2 的亮点在于训练和推理都非常高效。最终 DeepSeeK-V2 包含 236B 总参数，激活参数为 21B, 上下文长度为 128K. 作者还开源了 DeepSeek-V2-Lite, 一个 15.7B-A2.4B 的 MoE 模型，用于学术研究。
...
在预训练阶段结束之后，作者使用了 YaRN [@YaRN] 来将模型的上下文从 4K 扩展到 128K. 超参数设置为
...
作者在 32K 的上下文下额外训练了 1000 步，然后在推理阶段通过 YaRN [@YaRN] 将模型的上下文长度扩展到 128K.
