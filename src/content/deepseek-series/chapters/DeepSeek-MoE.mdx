...
description: DeepSeek 在 2024 年 1 月发布了 DeepSeekMoE, 一个解决 MoE 模型 scecialization 不足以及
  redundancy 问题的大模型系列。
authors:
- name: Mao Song
  url: https://maosong.website/
published: 2025-08-29 11:03:12+0800
modified: 2025-10-28 09:46:09+0800
tags:
- deepseek
- MoE
categories:
- LLM
showPdf: false
seoThumbImage: /posts/notes-on-deepseekmoe/DeepSeekMoE-ablation-expert-specialization.png
---
...
作者在 2B-A0.6B 的模型进行了实验，结果显示模型表现超过了 [GShard](/p/gshard/), 说明了 DeepSeekMoE 模型架构的有效性。
...
<Image src={deepseekmoe_ablation_expert_specialization} alt="Ablation study on expert specialization" />
...
<Image src={deepseekmoe_ablation_number_activated_experts} alt="Ablation study on activated routed experts" />
