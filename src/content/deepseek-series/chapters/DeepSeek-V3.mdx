...
作者在本文中提出了 DeepSeek-V3 [@DeepSeek-V3], 一个 671B-A37B 的 MoE 大语言模型。

在训练目标和架构上，作者做了如下改进：

1. efficiency inference: 采用了 [DeepSeek-V2](#deepSeek-v2) 提出的 [MLA](/p/notes-on-mla/)
2. cost-effective training: 采用了 [DeepSeekMoE](#deepSeek-moe) 提出了 MoE 架构
...
DeepSeek-V3 的架构与 [DeepSeek-V2](#deepSeek-v2) 的架构一致，如下图所示
